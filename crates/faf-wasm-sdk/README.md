...
> **v3 behavior:** `score_faf` scores against the always-33 model — one scorer for
> every project, from a solo script to a full enterprise monorepo. Tiers are
> canonical (🏆 ★ ◆ ◇ ● ○ ♡ — no medals). `compile_fafb` emits FAFb **v2**.
