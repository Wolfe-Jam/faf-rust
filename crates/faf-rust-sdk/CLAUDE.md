<!-- faf:start -->
<!-- faf: faf-rust-sdk | Rust | sdk | High-performance Rust SDK for FAF — parse, validate, score, .fafb binary. Zero-copy, inference-optimized. IANA-registered application/vnd.faf+yaml. One crate over faf-kernel + faf-fafb. -->
...
High-performance Rust SDK for FAF — parse, validate, score, .fafb binary. Zero-copy, inference-optimized. IANA-registered application/vnd.faf+yaml. One crate over faf-kernel + faf-fafb.
...
- **When:** Production since November 2025 — now v3.1.1, IANA-registered (application/vnd.faf+yaml)
